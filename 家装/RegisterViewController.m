...
- (void)viewDidLoad {
    ...
    PhoneNumber.keyboardType = UIKeyboardTypeNumbersAndPunctuation;//只能输入英语，符号，数字
...
// @"13672207712",@"phone",@"123456",@"pwd"
    NSDictionary *registerDic = [NSDictionary dictionaryWithObjectsAndKeys:PhoneNumber.text,@"phone",PassWord.text,@"pwd", nil];
//    NSError *parseError = nil;
//    
//    NSData *jsonData = [NSJSONSerialization dataWithJSONObject:registerDic options:NSJSONWritingPrettyPrinted error:&parseError];
//    
...
//    NSLog(@"JsonString%@",jsonString);
    ...
    NSString *path = @"http://jiazhuang.siruoit.com/index.php?api/api-createbyphone";

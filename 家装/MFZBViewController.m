...
@interface MFZBViewController ()<UIScrollViewDelegate,UITextFieldDelegate> {
...
@implementation MFZBViewController
{
    UIScrollView *scr;
...
//        scr.contentSize = CGSizeMake(0, 0);
    ...
    haomalab.lineBreakMode = NSLineBreakByWordWrapping;

...
-(void)setupMainView
{
    ...
    self.selectBtn.selected = self.isSelected;
    [self.selectBtn setImage:[UIImage imageNamed:@"Nocheck"] forState:UIControlStateNormal];
    [self.selectBtn setImage:[UIImage imageNamed:@"check"] forState:UIControlStateSelected];
